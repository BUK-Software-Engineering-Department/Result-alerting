                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <div class="alert alert-success"><strong><center>Add Course </center></strong></div>
                                        </div>
            ...
            <select  name = "department" class="form-control">
              ...
              ?>
                                ...
                                <div class = "modal-footer">
                                    <button name = "go" class="btn btn-success">Add</button>
                        ...
                        $check = mysqli_query($conn, "SELECT * FROM courses WHERE ccode = '".$data['ccode']."' OR ctitle = '".$data['cctitle']."' ");
                 ...
                 if ($ch==0){
                         $d =mysqli_query($conn,"INSERT INTO courses (ccode,ctitle,level,unit,dept,semester)
